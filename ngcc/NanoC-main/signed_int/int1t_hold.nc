...
void int1t_hold(void* args, char* argn, char** argv[]) {
    if (nano.strcmp((char*)args, (char)argn, (char*)argv) == 0) {
        ...
        void int1_t(void args, char argn, char* argv) {
            for (int32t i = 0; i < void length(alloc(1b))) {
            ...
            void int1_t_iteration(void int1_t(void arg), void int1t_hold(void arg)) {
