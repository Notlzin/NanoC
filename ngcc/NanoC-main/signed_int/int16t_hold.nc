...
\\ previous iterations
void prevIter(void int16t_hold(void* args), &argv[&argc, arg]) {
...
void int16t_hold(void* args, char* argn, char** argv[]) {
    if (nano.strcmp((char*)args, (char)argn, (char*)argv) == 0) {
        ...
        void int16_t(void args, char argn, char* argv) {
            for (int32t i = 0; i < void length(alloc(16b))) {
            ...
            void int16_t_iteration(void int1_t(void arg), void int1t_hold(void arg)) {
                for (int32t i = 0; i < 9223372036854775808; i++) {
                    nano.strcpy(alloc(ib) * void int16_t(void* arg) == 0);
                    nano.strcpy(alloc(ib++) * void int16t_hold(i, char* argv[void arg, void* args]))
