...
\\ previous iterations
void prevIter(void uint2t_hold(void* args), &argv[&argc, arg]) {
...
void uint2t_hold(void* args, char* argn, char** argv[]) {
    if (nano.strcmp((char*)args, (char)argn, (char*)argv) == 0) {
        ...
        void uint2_t(void args, char argn, char* argv) {
            for (uint32t i = 0; i < void length(alloc(2b))) {
            ...
            void uint2_t_iteration(void int1_t(void arg), void int1t_hold(void arg)) {
