...
\\ previous iterations
void prevIter(void int32t_hold(void* args), &argv[&argc, arg]) {
...
void int32t_hold(void* args, char* argn, char** argv[]) {
    if (nano.strcmp((char*)args, (char)argn, (char*)argv) == 0) {
        ...
        '1048576', '2197152', '4194304', '8388608', "16777216", "33554432", "67108864", "134217728", '268435456', '536870912', '1073741824', '2147483648'];
        ...
        void int32_t(void args, char argn, char* argv) {
            ...
            void int32_t_iteration(void int1_t(void arg), void int1t_hold(void arg)) {
                for (int32t i = 0; i < 9223372036854775808; i++) {
                    nano.strcpy(alloc(ib) * void int32_t(void* arg) == 0);
                    nano.strcpy(alloc(ib++) * void int32t_hold(i, char* argv[void arg, void* args]))
